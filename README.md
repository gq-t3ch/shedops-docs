...
<img src="assets/gqcode-logo.webp" width="220"/>
  ...
  <tr>
    ...
    <td valign="middle" width="200">
      <p align="center" style="margin: 0;">
        <strong style="font-size: 1.1em;">Zavala Quedena,<br />Gonzalo Andre</strong>
      </p>
    </td>
    <td valign="middle" width="180">
      <p align="center" style="margin: 0;">
        Ingeniería de<br />Software
      </p>
    </td>
    ...
    <td valign="top" width="250">
      <p style="margin: 0 0 6px 0;"><strong>Lenguajes</strong></p>
      ...
      <p style="margin: 0 0 6px 0;"><strong>Frameworks</strong></p>
      <p style="margin: 0 0 10px 0;">
        ...
        <img src="https://img.shields.io/badge/ASP.NET%20Core-512BD4?logo=.net&logoColor=white" />
      </p>
      <p style="margin: 0 0 6px 0;"><strong>Herramientas</strong></p>
      <p style="margin: 0 0 10px 0;">
  ...
  <tr>
    ...
    <td style="border: 1px solid black; text-align: justify; padding: 8px; vertical-align: top;">
      ...
      <p align="justify">
        ...
        (qué cambió, cuándo y quién), reduciendo coordinación manual.<br><br>
  ...
  <tbody>
    <tr>
      <td style="border: 1px solid black; padding: 8px;">
        <strong>Admin </br>(dueño/encargado del negocio de servicios)</strong>
      </td>
    ...
    <tr>
      <td style="border: 1px solid black; padding: 8px;">
        <strong>Staff </br>(personal operativo / colaboradores que atienden servicios)</strong>
      </td>
      <td style="border: 1px solid black; padding: 8px;" align="justify">
